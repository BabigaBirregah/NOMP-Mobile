...
public final class NOMPDataContract {
	...
	public static abstract class Ticket implements BaseColumns {
		...
		public static String[] getFields() {
			return new String[] {
					...
					COLUMN_NAME_CONTACT_PHONE,
					COLUMN_NAME_CONTACT_MOBILE,
					COLUMN_NAME_CONTACT_EMAIL,
	...
	public static abstract class Classification implements BaseColumns {
		...
		public static final String SQL_CREATE_ENTRIES = "CREATE TABLE IF NOT EXISTS "
				...
				+ COLUMN_NAME_PARENT_NAME
				+ " TEXT DEFAULT NULL"
				+ COMMA_SEP
				
				+ COLUMN_NAME_IS_PARENT
				+ " TINYINT DEFAULT 0"
				+ " )";
	...
	public static abstract class ActorType implements BaseColumns {
